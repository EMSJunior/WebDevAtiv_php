    ...
    <main>
        <table>
            ...
            <thead>
                ...
                <th>Populacao (2014)</th>
                <th>Densidade(2005)</th>
                <th>PIB (2015)</th>
                <th>(% total) (2015)</th>
                <th>PIB per capta (R$) (2005)</th>
                <th>IDH (2010)</th>
                <th>Alfabetizacao (2016)</th>
            ...
            <tbody>
                <?php
                    foreach ($estados as $dado) {
                        ...
                        echo "<td>{$dado['Abreviação']}</td>";
                        
                        
                        echo "<td>{$dado['Sede do Governo']}</td>";
                        
                        
                        echo "<td>" . number_format($dado['Área'], 2, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['População'], 0, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['Densidade'], 2, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['PIB (2015)'], 2, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['(% total) (2015)'], 2, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['PIB per capita (R$) (2015)'], 2, ',', '.') . "</td>";
                        
                        
                        echo "<td>" . number_format($dado['IDH (2010)'], 3, ',', '.') . "</td>";
                        
                        
                        echo "<td>{$dado['Alfabetização (2016)']}</td>";
                        
                        
                        echo "<td>{$dado['Mortalidade Infantil (2016)']}</td>";
                        
                        
                        echo "<td>{$dado['Expectativa de Vida (2016)']} anos</td>";
